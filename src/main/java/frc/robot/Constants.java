...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final double angleGearRatio = (21.35 / 1.0);
    ...
    public static final double maxSpeed = 180; // meters per second orginal value 4.5 FIXME: the speed does not seen to be changing
